"""Parity harness: wisdom v2 broker translator."""
...
from broker.wisdom.translator import WisdomOrderTranslator  # noqa: E402
from tests.parity.baseline.parity_v2_india_common import build_parity_output  # noqa: E402

NAME = "parity_v2_wisdom_india"


def generate() -> Dict[str, Any]:
    return build_parity_output(
        name=NAME, translator_cls=WisdomOrderTranslator,
