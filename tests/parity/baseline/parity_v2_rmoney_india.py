"""Parity harness: rmoney v2 broker translator."""
...
from broker.rmoney.translator import RMoneyOrderTranslator  # noqa: E402
from tests.parity.baseline.parity_v2_india_common import build_parity_output  # noqa: E402

NAME = "parity_v2_rmoney_india"


def generate() -> Dict[str, Any]:
    return build_parity_output(
        name=NAME, translator_cls=RMoneyOrderTranslator,
