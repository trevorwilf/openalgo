...
| T-35 (LEGACY_INDIA bucket < 50) | v9-bis-2 Phase 9 (partial) | T-23 reduced 211→167 (44 files moved). The remaining 167 entries are app.py / blueprints/* / non-promoted services/* / sandbox/* / database/* — separate per-component migrations needed to reach <50. |
