...
``market_regions.india.legacy_v1.sandbox.websocket_execution_engine``. This shim
...
from market_regions.india.legacy_v1.sandbox import websocket_execution_engine as _orig
