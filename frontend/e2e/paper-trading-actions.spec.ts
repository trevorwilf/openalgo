...
// Cancel any leftover open orders before every order-placing test.
// MARKET/STOP orders parked across previous tests trip Alpaca's
// wash-trade prevention on the next opposite-side LIMIT.
